...
public class TetherStakeBlock extends BlockWithEntity {

    private static final VoxelShape SHAPE = VoxelShapes.cuboid(0, 0, 0, 1, 1, 1);

    public TetherStakeBlock(Settings settings) {
        super(settings
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, ModBlockEntities.TETHER_STAKE, TetherStakeBlockEntity::tick);
    }
