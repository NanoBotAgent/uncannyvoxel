...
public final class UncannyRenderBridge {
    ...
    private static final ResourceLocation BLINK_SHADER = ResourceLocation.of("uncannyvoxel", "blink");
    private static final ResourceLocation PERIPHERAL_SHADER = ResourceLocation.of("uncannyvoxel", "peripheral_glitch");
    private static final ResourceLocation DREAD_SHADER = ResourceLocation.of("uncannyvoxel", "depth_of_field_dread");
